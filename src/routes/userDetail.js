...
router.get('/', async (req, res) => {
    ...
    //console.log(userID);
    await sequelize.query(`Select UserID,UserName,Sex, Balance,'Status',PhoneNumber From User Where userID = ${userID} and 
        exists (SELECT count(*) From TokenAdministrator where Value=${token})`)
